                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <a
                      ...
                      rel="noreferrer"
                      aria-label="LinkedIn"
                      className="size-8 rounded-lg bg-neutral-900 text-white flex items-center justify-center transition-all duration-200 hover:bg-[#0A66C2] hover:scale-105 shadow-xs"
                    >
                    ...
                    <a
                      ...
                      className="size-8 rounded-lg bg-neutral-900 text-white flex items-center justify-center transition-all duration-200 hover:bg-[#E4405F] hover:scale-105 shadow-xs"
                    >
                      <svg className="size-4 fill-current" viewBox="0 0 24 24">
                    ...
                    <a
                      ...
                      className="size-8 rounded-lg bg-neutral-900 text-white flex items-center justify-center transition-all duration-200 hover:bg-neutral-700 hover:scale-105 shadow-xs"
                    >
