                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noreferrer"
                      aria-label="YouTube"
                      className="size-8 rounded-lg bg-neutral-900 text-white flex items-center justify-center transition-all duration-200 hover:bg-[#FF0000] hover:scale-105 shadow-xs"
                    >
                      <svg className="size-4 fill-current" viewBox="0 0 24 24">
