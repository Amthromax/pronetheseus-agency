  ...
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      <div
        ...
        style={{
          background:
            "radial-gradient(1200px 700px at 15% 10%, rgba(194,65,12,0.35), transparent 60%), radial-gradient(900px 600px at 85% 90%, rgba(255,122,0,0.25), transparent 55%), linear-gradient(180deg, #050505 0%, #0a0a0a 50%, #050505 100%)",
        }}
      />
