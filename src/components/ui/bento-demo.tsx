...
const features = [
  ...
  },
  {
    ...
    background: (
      <div className="absolute top-4 right-2 h-[200px] w-3/4 rounded-xl border border-neutral-200/80 bg-white/80 p-4 shadow-sm backdrop-blur-md">
  ...
  },
  {
    ...
    background: (
      <Calendar
        mode="single"
        selected={new Date(2026, 8, 3, 0, 0, 0)}
        className="absolute top-10 right-0 origin-top scale-75 rounded-md border border-neutral-200 bg-white [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] transition-all duration-300 ease-out group-hover:scale-90"
      />
    ),
  },
];
