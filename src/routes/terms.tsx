...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — Pronetheseus" },
      { name: "description", content: "The terms that govern engagements with Pronetheseus." },
    ...
    <div className="pt-40">
      <div className="container-pad mx-auto max-w-3xl pb-24">
        ...
        <div className="mt-10 space-y-4 text-muted-foreground">
          <p>By engaging Pronetheseus, you agree to these simple terms. Full commercial terms are captured in your signed statement of work.</p>
